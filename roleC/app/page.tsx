...
const CONTEXT_SCENARIOS = [
  ...
  },
  {
    ...
    note: '더위·미세먼지 조건에서 실내·공조 시설 위주로 재배열',
  },
  {
    tag: '☀️ 맑음 · 밤 8시',
    weather: '맑음 · 체감 19°',
...
const DIFFERENTIATORS = [
  ...
  },
  {
    icon: '🌦️',
    title: '날씨가 후보를 바꿉니다',
    desc: '비·미세먼지·폭염이 오면 점수만 깎이는 게 아니라, 애초에 골라지는 장소 집합이 달라집니다.',
  },
  {
    icon: '📝',
    title: '지어내지 않은 이유',
    desc: '추천마다 실제 블로그 후기 문장을 그대로 인용합니다. 근거 없는 한 줄 요약이 아닙니다.',
  },
];
      ...
      <main className="max-w-xl mx-auto px-5 pt-16 pb-24 sm:pt-24">
        ...
        <div className="space-y-4 mb-10">
          ...
          <p className="text-sm text-slate-500 leading-relaxed max-w-sm">
            나이·성향과 목적·인원·날씨·시간을 함께 읽고, 실제 리뷰 근거와 함께 3~5곳을 추천합니다.
          </p>
        </div>
