...
### 11.6 배포 환경 검증 결과 (조치 완료)
1. **Render 가입 시 결제수단 요구 여부:** 요구하지 않음 (무료 플랜 카드 등록 없음 확인)
2. **Supabase 실제 한도:** 무료 프로젝트 최대 2개 / 디스크 용량 500MB 한도 확인
3. **서울 열린데이터광장 일일 한도:** [1,000회] 호출 제한 확인
